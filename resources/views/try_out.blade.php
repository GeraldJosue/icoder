                                ...
                                <form class="form-horizontal" role="form" method="POST">
                                    ...
                                    <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                                        ...
                                        <div class="col-md-6">
                                                  ...
                                                  <button id="button_type" type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Individual<span class='caret'></span>
                                                  </button>
                                                  <ul class="dropdown-menu">
                                                    <li><a id="one" href="#">Individual</a></li>
                                                    <li><a id="two" href="#">Grupal</a></li>
                                                    <li role="separator" class="divider"></li>
                                                    <li><a id="three" href="#">Individual y Grupal</a></li>
                                                  </ul>
                                                <input id="sport_type" type="text" name="sport_type" hidden="true" readonly value="1">
                                    ...
                                    {{ csrf_field() }}
                                        ...
                                        <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }}">
                                            ...
                                            <div class="col-md-6">
                                                  ...
                                                  <button id="u_button_type" type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">Tipo<span class='caret'></span>
                                                  </button>
                                                  <ul class="dropdown-menu">
                                                    <li><a id="u_one" href="#">Individual</a></li>
                                                    <li><a id="u_two" href="#">Grupal</a></li>
                                                    <li role="separator" class="divider"></li>
                                                    <li><a id="u_three" href="#">Individual y Grupal</a></li>
                                                  </ul>
                                                <input id="new_sport_type" type="text" name="new_sport_type" hidden="true" readonly value="1">
                                            </div>
                                        </div>
